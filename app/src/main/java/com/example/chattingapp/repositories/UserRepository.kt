...
interface UserRepository {
    ...
    suspend fun sendMultipleChats(date: String, listChats: List<Chat>)
    ...
    suspend fun uploadStatusImagesToFirebaseStorage(userId:String,username:String, photoUrls:List<Uri>,adapter:RecentUpdatesAdapter)
    ...
    suspend fun updateClickedStatus(id:String,currentUser:String)
    ...
    suspend fun getAllCalls(id:String):Flow<ScreenState<List<Calls>>>
}