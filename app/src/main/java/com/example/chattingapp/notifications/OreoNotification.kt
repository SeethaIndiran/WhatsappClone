...
class OreoNotification(base: Context?): ContextWrapper(base) {
    ...
    companion object{
        private const val CHANNEL_ID = "com.example.chattingapp"
        private  const val CHANNEL_NAME = "ChatsApp"
    }
    init {
    ...
    @TargetApi(Build.VERSION_CODES.O)
    fun getOreoNotificationForCalls(title:String?,
                            body:String?,
                            pendingIntent: PendingIntent?,
                                    remoteView:RemoteViews,
                                    remoteViewEx:RemoteViews,
        ...
        return  Notification.Builder(applicationContext, CHANNEL_ID)
            ...
            .setCustomBigContentView(remoteViewEx)
            .setAutoCancel(true)
